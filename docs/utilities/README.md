...
- [API Status (Java SDK)](./status.md) — Call status() on the Java SDK utilities resource for a public liveness check of Market Data API services, with an online flag and uptime percentiles.
